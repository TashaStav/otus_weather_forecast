...
Использование
1. Перейдите на страницу приложения https://tashastav.github.io/otus_weather_forecast/.
2. На странице Home отразится погода и карта местности по Вашей геолокации.
2. Введите название интересующего города.
3. Нажмите кнопку «Show» или Enter.
4. Приложение отобразит текущую погоду в выбранном городе, карту местности и добавит данный город в историю просмотров.
5. При необходимости просмотра погоды в ранее введенном городе перейдите на страницу History и нажмите на название города в списке истории.
